...
public class MainWindowModel
{
    ...
    private void updateCompanies(List<Company> c)
    {
        companies.clear();
        companies.addAll(c);
    }
    ...
    {
        updateCompanies(bm.getAllCompanies());
    }
    ...
    {
        updateCompanies(bm.getCompanysFromBusinessRole(role));
    }
    ...
    {
        updateCompanies(bm.getCompaniesFromCategories(category));
    }
